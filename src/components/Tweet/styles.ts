...
import {RocketseatIcon as RocketIcon} from '../RocketseatIcon'
...
export const RocketseatIcon = styled(RocketIcon)`
width: 16px;
height: 16px;
...
export const RetweetIcon = styled(RocketIcon)`${iconCSS}`
